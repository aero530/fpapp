...
pub(super) fn in_out_year_rows(ui: &mut egui::Ui, a: &mut Value, uuid: &str) -> bool {
    let mut c = false;
...
pub(super) fn yearly_return_row(ui: &mut egui::Ui, a: &mut Value, uuid: &str) -> bool {
    let c = widgets::percent_input(
        ui,
        "Yearly Return (%):",
        uuid,
        &mut a["yearlyReturn"],
...
pub(super) const TAX_STATUS_TOOLTIP: &str = "How taxes impact this account:\n\
