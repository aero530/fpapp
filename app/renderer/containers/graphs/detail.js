      ...
      return (
        <div key="charts">
          ...
          <Paper className={classes.paper}>
            <Typography variant="h6" id="modal-title">Retirement Accounts</Typography>
          ...
          <Paper className={classes.paper}>
            <Typography variant="h6" id="modal-title">College Savings</Typography>
            {Object.values(accounts).map((account) => {
          ...
          <Paper className={classes.paper}>
            <Typography variant="h6" id="modal-title">Mortgage</Typography>
            {Object.values(accounts).map((account) => {
          ...
          <Paper className={classes.paper}>
            <Typography variant="h6" id="modal-title">Loan</Typography>
            {Object.values(accounts).map((account) => {
          ...
          <Paper className={classes.paper}>
            <Typography variant="h6" id="modal-title">HSA</Typography>
            {Object.values(accounts).map((account) => {
              if (account.type === 'hsa') {
                return (
